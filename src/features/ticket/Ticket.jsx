...
const Ticket = () => {
  ...
  items-center p-3 px-7 lg:px-10 max-w-md mx-auto'>
      ...
      <div className="bg-indigo-600  text-gray-300 rounded-lg py-8 flex flex-col justify-evenly gap-4 h-3/4 max-w-md">
      ...
      <div className='w-[95%]  outline-dashed outline-1 opacity-70'></div>
        <img src={barcode} className='w-[70%] bg-white opacity-95 mt-6 lg:mt-8'/>
      </div>
