...
const Login = () => {
    ...
    const inputStyle = 'rounded p-3 lg:p-[0.9rem] bg-[rgba(39,40,53,255)] bg-opacity-75 text-gray-400 text-xs lg:text-sm placeholder-gray-400 placeholder-opacity-15 w-full';
    ...
    return (
        <div className='flex flex-col h-[80vh] w-full justify-evenly lg:p-[0.8rem]'>
            <h1 className='text-gray-300 text-center text-xl lg:text-3xl tracking-wide'>Login to your account</h1>
            <div className='flex flex-col justify-evenly  lg:h-[75%]  lg:py-1  px-7 lg:px-0 lg:mx-auto lg:w-full max-w-md'>
                <form className='flex flex-col gap-2  w-full'>
                    ...
                    <input name="email" id="email" required value={email} type="text" onChange={handleEmailChange} placeholder='johndoe@email.com' className={inputStyle} />
   ...
   Login
        ...
        <div>
            ...
            <img src={googleIcon} className='w-6 mr-2'/>
             ...
             <button  className='w-full bg-[rgba(39,40,53,255)] bg-opacity-75 text-gray-400  border-none rounded py-2  flex items-center justify-center  cursor-pointer hover:brightness-90 lg:text-2xl text-base  lg:mx-auto ' type="submit" >
